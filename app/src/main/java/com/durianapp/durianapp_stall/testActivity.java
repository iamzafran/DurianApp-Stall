...
public class testActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) testActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(testActivity.this.getComponentName()));
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            //this method will be running on UI thread
            pdLoading.dismiss();
            List<DataDurianSearch> data=new ArrayList<>();

            pdLoading.dismiss();
            if(result.equals("no rows")) {
                Toast.makeText(testActivity.this, "No Results found for entered query", Toast.LENGTH_LONG).show();
            }  else {
                ...
                try {
                    ...
                    mAdapter = new AdapterDurianSearch(testActivity.this, data);
                    mRVFish.setAdapter(mAdapter);
                    mRVFish.setLayoutManager(new LinearLayoutManager(testActivity.this));

                } catch (JSONException e) {
                    // You to understand what actually error is and handle it appropriately
                    Toast.makeText(testActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                    Toast.makeText(testActivity.this, result.toString(), Toast.LENGTH_LONG).show();
                }
